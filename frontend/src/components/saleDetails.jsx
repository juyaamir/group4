...
const ProductDetails = ({ favAmazonProduct, setFavAmazonProduct }) => {
    ...
    <div className="flex flex-wrap mx-auto my-6 border-2 border-gray-200 w-2/3 justify-around rounded-lg ">
      <div className="w-80 p-3">
        <div className="relative">
          ...
          <img
            src={logo}
            alt="logo"
            className="h-10 absolute w-10 rounded-full bottom"
          />
        </div>
        ...
        <div className="flex  justify-between flex-wrap p-1 ">
            ...
            <Heart
              ...
              onClick={() =>
                toggleHeart(
                  ...
                  product.quickview.content[0].content[0].value,
                  product.rating
                )
              }
              animationScale={1.2}
          ...
          <p className=" text-xl bg-red-500 text-white px-2">
            -{product.discount} %
          </p>
          {!buy ? (
            <div className="">
              <MdAddShoppingCart className="text-3xl text-gray-400 cursor-not-allowed" />
            </div>
          ) : (
            <div className="">
              <MdAddShoppingCart className="text-4xl hover:cursor-pointer" />
            </div>
          )}
        </div>
        <p className="text-gray-500">
          Ships from: <span className=" underline">journeypack.com</span>
        </p>
        <p className=" text-gray-500">
          Returns:{" "}
      ...
      <div className="w-3/5 text-lg font-medium pr-8 pt-2">
        ...
        <p className="text-red-600 p-1 ">
          <span className="bg-red-600 text-white text-base px-1">
            Limited time deal
          </span>{" "}
          €{product?.price}
        </p>
        ...
        <p className="text-xs italic">
          Prices for items sold by{" "}
          <span className="Sofia underline">JourneyPack</span> include VAT.
        ...
        <Tabs>
          ...
          <TabPanel>
            <p className="text-xs">
              {product.moreInformation.content[0].content[0].value}
            </p>
          </TabPanel>
          <TabPanel>
            {!product.description ? (
              <>
                <p className="text-base font-bold">
                  MODEL :{" "}
                  <span className="text-sm font-normal">{product.model}</span>
                </p>
                <p className="text-base font-bold">
                  BRAND :{" "}
                  <span className="text-sm font-normal">{product.brand}</span>
                </p>
                <p className="text-base font-bold">
                  COLOR :{" "}
                  <span className="text-sm font-normal">{product.color}</span>
                </p>
                <p className="text-base font-bold">
                  SCREEN :{" "}
                  <span className="text-sm font-normal">{product.screen}</span>
                </p>
                <p className="text-base font-bold">
                  PROCESSOR :{" "}
                ...
                <p className="text-base font-bold">
                  RAM :{" "}
                  <span className="text-sm font-normal">{product.ram}</span>
                </p>
              </>
            ) : (
              <p className="text-base font-bold">
